...
#
# Generated by Vivado on Fri Dec 08 09:48:26 PST 2017
...
# Script info
echo -e "rom.sh - Script generated by export_simulation (Vivado v2017.3 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_0 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rom xil_defaultlib.rom xil_defaultlib.glbl -log elaborate.log
}
