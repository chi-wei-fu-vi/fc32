...
#
# Generated by export_simulation on Fri Feb 09 15:25:17 PST 2018
#
################################################################################
...
'-reset_run' switch to the './pcie4_uscale_plus_1.sh' script.

./pcie4_uscale_plus_1.sh -reset_run
...
./pcie4_uscale_plus_1.sh -noclean_files

For more information on the script, please type './pcie4_uscale_plus_1.sh -help'.
