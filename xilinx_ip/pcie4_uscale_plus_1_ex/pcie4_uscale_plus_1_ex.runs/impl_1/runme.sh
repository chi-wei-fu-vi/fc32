...
HD_PWD='/home/chiwei/work/checkout/xilinx-bali.git.new/xilinx_ip/pcie4_uscale_plus_1_ex/pcie4_uscale_plus_1_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_pcie4_uscale_ep.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xilinx_pcie4_uscale_ep.tcl -notrace
