...
#
# Generated by export_simulation on Mon Jan 08 10:23:26 PST 2018
#
################################################################################
...
'-reset_run' switch to the './s5_native_phy_16gbps.sh' script.

./s5_native_phy_16gbps.sh -reset_run
...
./s5_native_phy_16gbps.sh -noclean_files

For more information on the script, please type './s5_native_phy_16gbps.sh -help'.
