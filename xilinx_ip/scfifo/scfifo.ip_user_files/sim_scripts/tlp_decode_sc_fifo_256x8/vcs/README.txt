...
#
# Generated by export_simulation on Wed Dec 06 11:58:19 PST 2017
#
################################################################################
...
'-reset_run' switch to the './tlp_decode_sc_fifo_256x8.sh' script.

./tlp_decode_sc_fifo_256x8.sh -reset_run
...
./tlp_decode_sc_fifo_256x8.sh -noclean_files

For more information on the script, please type './tlp_decode_sc_fifo_256x8.sh -help'.
