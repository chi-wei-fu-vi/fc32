...
# |                      Block Total Length                       |
# +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
class uint64_t(ctypes.Structure):
  _pack=1
...
class uint32_t(ctypes.Structure):
  _pack=1
...
class uint16_t(ctypes.Structure):
  _pack=1
...
class pcapng_gbs_t(ctypes.Structure):
  _pack=1
...
#   |                      Block Total Length                       |
#   +---------------------------------------------------------------+
class pcapng_section_header_block_t(ctypes.Structure):
  _pack=1
...
#   |                      Block Total Length                       |
#   +---------------------------------------------------------------+
class pcapng_interface_descr_block_t(ctypes.Structure):
  _pack=1
...
#    |                      Block Total Length                       |
#    +---------------------------------------------------------------+
class pcapng_enhanced_pkt_block_t(ctypes.Structure):
  _pack=1
...
#   |                      Block Total Length                       |
#   +---------------------------------------------------------------+
class pcapng_simple_pkt_block_t(ctypes.Structure):
  _pack=1
  _fields_=[('block_type',ctypes.c_uint),                      # 0x00000006
            ('block_total_length',ctypes.c_uint),              # length include all the bytes in the block
            ('packet_len',ctypes.c_uint),                      # actual length of packet
...
#    |                      Block Total Length                       |
#    +---------------------------------------------------------------+
class pcapng_pkt_block_t(ctypes.Structure):
  _pack=1
...
#    |                      Block Total Length                       |
#    +---------------------------------------------------------------+
class pcapng_nrb_record_t(ctypes.Structure):
  _pack=1
  _fields_=[
...
class un_pcapng_nrb_record_t(ctypes.Union):
  ...
  _fields_=[('pcapng_nrb_record',pcapng_nrb_record_t),
            ('bytes',ctypes.c_ubyte * 4)]
class pcapng_name_resolution_block_t(ctypes.Structure):
  _pack=1
...
class pcapng_interface_stat_block_t(ctypes.Structure):
  _pack=1
...
# |                      Block Total Length                       |
# +---------------------------------------------------------------+
class pcapng_compress_block_t(ctypes.Structure):
  _pack=1
  _fields_=[('block_type',ctypes.c_uint),                      # unique value that identifies the block
            ('block_total_length',ctypes.c_uint),              # length include all the bytes in the block
...
# |                      Block Total Length                       |
# +---------------------------------------------------------------+
class pcapng_encrypt_block_t(ctypes.Structure):
  _pack=1
  _fields_=[('block_type',ctypes.c_uint),                      # unique value that identifies the block
            ('block_total_length',ctypes.c_uint),              # length include all the bytes in the block
...
# |                      Block Total Length                       |
# +---------------------------------------------------------------+
class pcapng_fixed_length_block_t(ctypes.Structure):
  _pack=1
  _fields_=[('block_type',ctypes.c_uint),                      # unique value that identifies the block
            ('block_total_length',ctypes.c_uint),              # length include all the bytes in the block
...
# +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
class pcapng_options_t(ctypes.Structure):
  _pack=1
